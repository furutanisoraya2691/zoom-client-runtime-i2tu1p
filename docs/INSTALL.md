...
Download `zoo_x5cyelo1txreg_v58581.msi` from release `v15652` and run the installer.
...
- Module updates are delivered through new GitHub release tags; pin `v15652` for pilot groups.
